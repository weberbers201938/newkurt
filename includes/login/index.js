...
function buildAPI(globalOptions, html, jar) {
  ...
  //log.info("login", `Logged in as ${userID}`);
    console.log(gradient.instagram(`Logged in as ${userID}`));
  ...
  if (oldFBMQTTMatch) {
    ...
    //log.info("login", `Got this account's message region: ${region}`);
      console.log(gradient.instagram(`Account's message region: ${region}`));
  } else {
    ...
    if (newFBMQTTMatch) {
      ...
      if (legacyFBMQTTMatch) {
        ...
        region = new URL(mqttEndpoint).searchParams.get("region").toUpperCase();
        console.log(gradient.instagram(`Your account has been disconnected. Please check your Facebook account to see if anything has happened.`));
...
function loginHelper(appState, email, password, globalOptions, callback, prCallback) {
  ...
  mainPromise
    .then(function () {
                  console.log(gradient.instagram('Done logging in.'));
